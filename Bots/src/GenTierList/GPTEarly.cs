...
public class GamePhaseStrategyEarly : IGamePhaseStrategy
{
    ...
    public int CardsValues(SeededGameState gameState, TierListEv cardTierList, int startRoundcardsCount)
    {
        int val = 0;
        ...
        {
            val += (int)cardTierList.GetCardTier(card.Name, 0);
        ...
        {
            val -= (int)cardTierList.GetCardTier(card.Name, 0) / 3;
        }
        return val;
    }
