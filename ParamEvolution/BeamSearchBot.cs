...
public class BeamSearchBot : AI
{
    ...
    const int patronFavour = 50;
    const int patronNeutral = 10;
    const int patronUnfavour = -50;
    const int coinsValue = 1;
    const int powerValue = 40;
    const int prestigeValue = 50;
    const int agentOnBoardValue = 30;
    const int hpValue = 3;
    const int opponentAgentsPenaltyValue = 40;
    const int potentialComboValue = 3;
    const int cardValue = 10;
    const int penaltyForHighTierInTavern = 2;
    const int numberOfDrawsValue = 10;
    const int enemyPotentialComboPenalty = 1;
    const int k = 20;
    private Random myRNG = new Random();
    const string patronLogPath = "patronBeamSearchBot.txt";
